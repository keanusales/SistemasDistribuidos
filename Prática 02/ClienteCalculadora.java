        ...
        try {
            ...
            try (Scanner input = new Scanner(System.in)) {
                ...
                while (choice != 0) {
                    ...
                    System.out.print("19.) Hypotenuse.\n");
                    System.out.print("20.) Factorial.\n");
                    ...
                    try {
                        switch (choice) {
                            ...
                            case 19 -> {
                                Numero hipNum1, hipNum2, hipTotal;
                                System.out.println("Enter The First Number (Leg 1): ");
                                hipNum1 = new NumeroImpl(input.nextDouble());
                                System.out.println("Enter The Second Number (Leg 2): ");
                                hipNum2 = new NumeroImpl(input.nextDouble());
                                hipTotal = calc.hipotenusa(hipNum1, hipNum2);
                                System.out.println("The Hypotenuse is: " + hipTotal.getValor() + "\n");
                            }

                            case 20 -> {
                                Numero fatNum, fatTotal;
                                System.out.println("Enter Your Number: ");
                                fatNum = new NumeroImpl(input.nextInt());
                                fatTotal = calc.fatorial(fatNum);
                                System.out.println("The Factorial of Your Number is: " + fatTotal.getValor() + "\n");
                            }
